...
{   
    ...
    # Retorna template dashboard 
    public function loadTemplateDashboard($viewName, $dados = array(), $breadcrumb = false) {
        extract($dados);
        require_once "views/dashboard.php";
    }

   
    public function loadViewInTemplateDashboard($viewName, $dados = array()) {
    extract($dados);
        require_once "views/".$viewName.'.php';
    }
